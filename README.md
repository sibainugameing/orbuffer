...
Completed downloads are checked against the local files when their file paths and expected lengths are available. The UI reports `Verified`, `Size mismatch`, or `Unavailable`. This is a size check, not cryptographic hash verification.
